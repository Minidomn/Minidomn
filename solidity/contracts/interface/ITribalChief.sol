...
interface ITribalChief {
    ...
    ///@notice Getters for public variables
    function depositInfo(uint256 poolId, address staker, uint256 index) external view returns(uint256 amount, uint128 unlockBlock, uint128 multiplier);
}
